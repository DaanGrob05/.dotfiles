...
sudo apt install git-all curl gcc ffmpeg ubuntu-restricted-extras libavcodec-extra ripgrep fd-find fzf xclip bat tmux gnome-tweaks gnome-shell-extensions build-essential tmuxinator nodejs npm flatpak pipx i3 autorandr arandr pulseaudio-utils protobuf-compiler python3 python3-tk python3-venv -y
